...
class AddStudent:
    def __init__(self, root):
        ...
        img1=Image.open(r"C:\Users\Hp\Desktop\face_recognition_project_cse299\images\stu.png")
        ...
        img2=Image.open(r"C:\Users\Hp\Desktop\face_recognition_project_cse299\images\stu2.png")
        ...
        img3=Image.open(r"C:\Users\Hp\Desktop\face_recognition_project_cse299\images\stu3.png")
        ...
        img4=Image.open(r"C:\Users\Hp\Desktop\face_recognition_project_cse299\images\stu3.png")
        img4=img4.resize((1920,710), Image.LANCZOS) 
        self.photoimg4=ImageTk.PhotoImage(img4)
        bg_img=Label(self.root,image=self.photoimg4)
        bg_img.place(x=0,y=140, width=1920, height=710)
        title_lbl=Label(bg_img,text="FACE RECOGNITION ATTENDANCE SYSTEM", font=("times new roman", 35, "bold"), bg="white", fg="red") 
        title_lbl.place(x=0,y=0,width=1540,height=45)

        main_frame = Frame(bg_img, bd=2)
        main_frame.place(x=10,y=50,width=1512,height=600)

        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white", relief=RIDGE, text="Student Details", font=("times new roman", 12, "bold"))
        Left_frame.place(x=10,y=10,width=740,height=580)

        img_left=Image.open(r"C:\Users\Hp\Desktop\face_recognition_project_cse299\images\stu3.png")
        img_left=img_left.resize((725,130), Image.LANCZOS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)

        f_lbl=Label(Left_frame, image=self.photoimg_left)
        f_lbl.place(x=5,y=0,width=725, height=130)      
        ...
        dep_combo["values"]=("Select Department", "Computer", "IT", "Civil", "Mechnical", "BBA", "Economics")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course", "FE","CSE373", "TE","CSE225", "CSE299","BUS372")
        ...
        class_Student_frame=LabelFrame(Left_frame, bd=2, bg="white", relief=RIDGE, text="Class Student inform", font=("times new roman",12,"bold"))
        ...
        img_right=Image.open(r"C:\Users\Hp\Desktop\face_recognition_project_cse299\images\stu3.png")
        img_right=img_right.resize((725,130), Image.LANCZOS)
        ...
        table_frame.place(x=5,y=135,width=725,height=420)
